...
mod provides_shape_area;
mod provides_shape_position;
mod provides_size;
mod shape;
mod shape_area;
mod shape_area_range;
mod shape_position;
...
pub use has_shape_area::HasShapeArea;
...
pub use is_shape_area::IsShapeArea;
...
pub use provides_shape_area::ProvidesShapeArea;
pub use provides_shape_position::ProvidesShapePosition;
pub use provides_size::ProvidesSize;
pub use shape::Shape;
pub use shape_area::ShapeArea;
pub use shape_area_range::ShapeAreaRange;
